...
{	
	...
	implements Mapper<LongWritable, Text, Text, Text> 
	{
		...
		throws IOException 
		{
			...
			if (threadpaths != null)
			{
				reporter.incrCounter("Pga", "allneedsplit", 1);
				...
				if (!masterid.equals(node.getNodeId()))
				{
					...
					reporter.incrCounter("Pga", "needsplit", 1);
				}
				else
				{
					...
					reporter.incrCounter("Pga", "resolved", 1);
					...
					reporter.incrCounter("Pga", "uniquethreadedbp", threadedbp);
					...
					reporter.incrCounter("Pga", "totalthreadedbp", totalthreadedbp);
				}
			}
...
///////////////////////////////////////////////////////////////////////////	
	...
	{ 
		...
		conf.setJobName("ThreadResolve " + inputPath + " " + PgaConfig.K);
...
///////////////////////////////////////////////////////////////////////////	
	...
	{
		String inputPath  = "/Users/mschatz/pga/Ec100k/11-scaffold.1.threadible";
		String outputPath = "/users/mschatz/pga/Ec100k/11-scaffold.1.resolved";
