...
{	
	...
	implements Reducer<Text, Text, Text, Text> 
	{
		...
		public void reduce(Text mertag, Iterator<Text> iter,
			...
			reporter.incrCounter("Pga", "chains",        chains);
			reporter.incrCounter("Pga", "cchains",       cchains);
			reporter.incrCounter("Pga", "totalchainlen", totallen);
			reporter.incrCounter("Pga", "saved",         saved);
						}
	}
	...
	{ 
		...
		conf.setJobName("QuickMerge " + inputPath + " " + PgaConfig.K);
