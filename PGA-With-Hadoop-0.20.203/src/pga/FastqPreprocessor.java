...
{	
    ...
    implements Mapper<LongWritable, Text, Text, Text> 
	{
                ...
                throws IOException 
        {
			...
			else if (idx == 3)
			{
				...
				reporter.incrCounter("Pga", "preprocessed_reads", 1);
				reporter.incrCounter("Pga", counter, 1);
			}
	...
	{
		//String inputPath  = "/Users/mschatz/build/Pga/data/Ba100k.sim.fq";
		String inputPath  = args[0];
		String outputPath = args[1];
		
		PgaConfig.PREPROCESS_SUFFIX = 1;
		//PgaConfig.TEST_MODE = true;
		PgaConfig.TEST_MODE = false;
		//PSK Commented to check 
