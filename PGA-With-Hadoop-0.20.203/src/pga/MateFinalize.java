...
{	
	...
	implements Reducer<Text, Text, Text, Text> 
	{
				...
				throws IOException 
		{
			...
			if ((fdegree > 1) || (rdegree > 1))
			{
				if (updates.size() > 0)
				{
					reporter.incrCounter("Pga", "updates", 1);
	...
	{
		String inputPath  = "/users/mschatz/pga/Ec200k/11-scaffold.2.matepath";
		String outputPath = "/users/mschatz/pga/Ec200k/11-scaffold.2.final";
