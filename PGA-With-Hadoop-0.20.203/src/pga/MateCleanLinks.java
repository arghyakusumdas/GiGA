...
{	
    ...
    implements Mapper<LongWritable, Text, Text, Text> 
	{
                ...
                throws IOException 
        {
			...
			reporter.incrCounter("Pga", "msgs", 1);
        }
	}
	...
	implements Reducer<Text, Text, Text, Text> 
	{
				...
				throws IOException 
		{
			...
			if (!deadedges.isEmpty())
			{
				...
				reporter.incrCounter("Pga", "removed_edges", removed_edges);
			}
	...
	{
		String inputPath  = "/Users/mschatz/pga/Ec500k.cor.21/11-scaffold.1.final";
