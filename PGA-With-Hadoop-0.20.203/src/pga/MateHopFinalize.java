...
{	
	...
	implements Mapper<LongWritable, Text, Text, Text> 
	{
		...
		throws IOException 
		{
			...
			if (threads != null)
			{
				reporter.incrCounter("Pga", "aborted_threads", threads.size());
				reporter.incrCounter("Pga", "aborted_threads_nodes", 1);
			...
			if (bundles != null)
			{
				...
				for(String startnode : paths.keySet())
				{
					...
					if (plist.size() > 1)
					{
						...
						reporter.incrCounter("Pga", "total_ambiguous", 1);
						continue;
					}
				...
				for (String pathstr : dirpaths)
				{
					if (pathstr != null)
					{
						...
						while (curidx > 0)
						{
							...
							reporter.incrCounter("Pga", "resolved_edges", 1);
						}

						reporter.incrCounter("Pga", "resolved_bundles", 1);
					}
				}
			}
	...
	{
		String inputPath  = "/users/mschatz/pga/Ec100k/11-scaffold.3.search9";
		String outputPath = "/users/mschatz/pga/Ec100k/11-scaffold.3.matepath";
